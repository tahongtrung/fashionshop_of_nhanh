...
require_once("pdProduct.php");
    if(isset($_POST['keyword'])){
        ...
        $sql_search = "SELECT pd.id,pd.category_id,pd.name,mf.mf_name,pd.img,pd.price FROM manufacture as mf JOIN product as pd ON pd.manufacture = mf.id WHERE pd.name LIKE '%$keyword%' LIMIT 12";
                        ...
                        <li style="padding-right:1.5%;padding-top:30px;">
                            <div class="img-product">
                                ...
                                <div style="width:100%;height:50px;">
                                    <a href="productdetail.php?id=<?php echo $row['id']?>&ct=<?php echo $row['categoty_id']?>"><?php echo $row['name']; ?></a>
                                </div>
